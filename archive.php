            ...
            <header>
                <h1 class="heading">
                        <?php
                            ...
                            if ( is_day() ) :
                                echo ''.__('Daily Archives', 'simgo' ).':'.get_the_date();
    
                            elseif ( is_month() ) :
                                echo ''.__('Monthly Archives', 'simgo' ).':'.get_the_date( _x('F Y','monthly archives date format', 'simgo' ));
    
                            elseif ( is_year() ) :
                                echo ''.__('Yearly Archives', 'simgo' ).':'.get_the_date( _x('Y','yearly archives date format', 'simgo' ));
