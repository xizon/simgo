    ...
    class gallery_metabox {
        ...
        function render() {
                        ...
                        foreach ( $attachments as $attachment_id ) {
                            if ( wp_attachment_is_image ( $attachment_id  ) ) {
                                echo '<li class="image" data-attachment_id="' . $attachment_id . '"><div class="attachment-preview"><div class="thumbnail">
                                            ...
                                            <a href="#" class="uix-gmb-remove" title="' . __( 'Remove image', 'simgo' ) . '"><div class="media-modal-icon"></div></a>
                                        </div></li>';
                            }
                        }
                    } ?>
            ...
            <p class="add_gallery_images hide-if-no-js">
                <a href="#" class="button-primary"><?php _e( 'Add/Edit Images', 'simgo' ); ?></a>
            </p>
            ...
            <p>
                <label for="easy_image_gallery_link_images">
                    <input type="checkbox" id="easy_image_gallery_link_images" value="on" name="easy_image_gallery_link_images"<?php echo $checked; ?> /> <?php _e( 'Enable Lightbox for this gallery?', 'simgo' )?>
                </label>
            </p>
                ...
                jQuery(document).ready(function($){
                    ...
                    jQuery( '.add_gallery_images' ).on( 'click', 'a', function( event ) {
                        ...
                        image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                            ...
                            title: "<?php _e( 'Add Images to Gallery', 'simgo' ); ?>",
                            button: {
                                text: "<?php _e( 'Add to gallery', 'simgo' ); ?>",
                            },
                            multiple: true
                        });
                                     ...
                                     $gallery_images.append('\
                                        <li class="image" data-attachment_id="' + attachment.id + '">\
                                            <div class="attachment-preview">\
                                               ...
                                               <a href="#" class="uix-gmb-remove" title="<?php esc_attr_e( 'Remove image', 'simgo' ); ?>"><div class="media-modal-icon"></div></a>\
                                            </div>\
                                        </li>');
                                }
                            } );
