...
/******************Change this*******************/
$api_url = 'https://uiux.cc/wp-themes/'.SIMGO_THEME_SLUG.'/update/';
/************************************************/
...
add_filter('pre_set_site_transient_update_themes', 'simgo_check_for_update');

function simgo_check_for_update($checked_data) {
...
add_filter('themes_api', 'simgo_api_call', 10, 3);

function simgo_api_call($def, $action, $args) {
