...
class Simgo_Dropdown_Walker_Nav_Menu extends Walker_Nav_Menu {
 ...
 *
 */		
function Simgo_Custom_Menu_Scripts( $frontend_scripts = null ) {
	

	Simgo_Core::enqueue_inline_script( SIMGO_THEME_SLUG . '-js-menu', '
...
add_action( 'wp_enqueue_scripts', 'Simgo_Custom_Menu_Scripts' );
